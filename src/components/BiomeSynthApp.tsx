...
import SwimmingFish from "./biome-synth/components/SwimmingFish";
import SeaCorals from "./biome-synth/components/SeaCorals";
import FloatingBubbles from "./biome-synth/components/FloatingBubbles";
